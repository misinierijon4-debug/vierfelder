...
import { ansageStand, ansageZielText, zaehltAusZustand } from '../../lib/ansagen'
...
/**
 * eine laufende ansage gegen dich steht im tracker, genau dort, wo man sie
 * einlöst. nichts, wenn keine läuft — der platz gehört sonst dem eintragen.
 */
      ...
      {offen.map(({ ansage, stand }) => {
        ...
        return (
          <button
            ...
            aria-label={`${von.name} sagt an: ${ansageZielText(ansage.feld, ansage.ziel)} bis samstag, ${stand.erreicht} von ${stand.ziel}. zum duell`}
          >
