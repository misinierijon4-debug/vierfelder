-- schlafintegration für zwei profile
create extension if not exists pgcrypto with schema extensions;

create table schlafnaechte (
...
create table schlaf_import_tokens (
...
create index schlafnaechte_nutzer_nacht_idx on schlafnaechte (user_id, nacht desc);
